<template>
    ...
    <FormKit
        ...
        :validation-messages="{
        matches: 'Username can only contain english letters, numbers, hyphens and underscores.'
        }"
    ...
    <FormKit
        ...
        :validation-messages="{
            matches: 'Password can only english contain letters, numbers and some special characters (i.e. &.-!?@#$%^&*).'
        }"
